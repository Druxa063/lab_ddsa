package src.lab.jchord.test;

import src.lab.jchord.Chord;
import src.lab.jchord.ChordException;
import src.lab.jchord.ChordNode;
import src.lab.jchord.Hash;
import src.lab.jchord.image.Drawer;
...
public class Main2 {
	...
	public static final int NUM_OF_NODES = 12;
...
//		drawer.drawFingerTable(chord.getSortedNode(9));
		drawer.writeFile("src/main/resources/ring.png");
